...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>ramcosta</b> with <b>io.github.raamcosta.compose-destinations:core</b> coordinates and
     * with version reference <b>ramcostacore</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getRamcosta() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("ramcosta");
    }

    /**
     * Dependency provider for <b>ramcostaksp</b> with <b>io.github.raamcosta.compose-destinations:ksp</b> coordinates and
     * with version reference <b>ramcostacore</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     ...
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getRamcostaksp() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("ramcostaksp");
    }
    ...
    public static class CoilLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>image</b> with <b>io.coil-kt:coil-compose</b> coordinates and
    ...
    public static class HiltLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>lib</b> with <b>com.google.dagger:hilt-android</b> coordinates and
         * with version reference <b>hilt</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
    ...
    public static class NavigationLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>navigation.hilt</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class OpenLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>open.ai</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public OpenAiLibraryAccessors getAi() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
    ...
    public static class OpenAiLibraryAccessors extends SubDependencyFactory {
        private final OpenAiChatLibraryAccessors laccForOpenAiChatLibraryAccessors = new OpenAiChatLibraryAccessors(owner);

        public OpenAiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>open.ai.chat</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public OpenAiChatLibraryAccessors getChat() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForOpenAiChatLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class OpenAiChatLibraryAccessors extends SubDependencyFactory {

        public OpenAiChatLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>gpt</b> with <b>com.aallam.openai:openai-client</b> coordinates and
         * with version reference <b>openAi</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getGpt() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("open.ai.chat.gpt");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>composeMaterial</b> with value <b>1.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>openAi</b> with value <b>3.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getOpenAi() { return getVersion("openAi"); }

        /**
         * Version alias <b>ramcostacore</b> with value <b>1.9.52</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRamcostacore() { return getVersion("ramcostacore"); }
    ...
    public static class NavigationVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>navigation.hilt</b> with value <b>1.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
